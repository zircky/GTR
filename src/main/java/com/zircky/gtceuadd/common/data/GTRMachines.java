...
public class GTRMachines {
  ...
  public final static MultiblockMachineDefinition ComponentAssemblyLine = GTRRegistries.REGISTRATE.multiblock("component_assembly_line", WorkableElectricMultiblockMachine::new)
      ...
      .pattern(definition -> FactoryBlockPattern.start()
          ...
          .where('I', blocks(CASING_STEEL_SOLID.get()).or(Predicates.blocks(ITEM_IMPORT_BUS[5].getBlock())).setMinGlobalLimited(1))
          .where('G', blocks(CASING_LAMINATED_GLASS.get()))
          .where('P', blocks(CASING_PTFE_INERT.get()))
          .where('A', blocks(CASING_ASSEMBLY_CONTROL.get()))
          .where('L', blocks(CASING_ASSEMBLY_LINE.get()))
