...
import static com.zircky.gtceuadd.api.data.info.GTRMaterialFlags.*;
...
//    GTRFluid.register();
  ...
  public static void register() {
    ...
    Neutronium.addFlags(GENERATE_LONG_ROD, GENERATE_RING, GENERATE_ROUND, GENERATE_GEAR, GENERATE_SMALL_GEAR);

    CuBe = new Material.Builder("cube")
      .ingot().dust()
      .color(0xAC4A09)
      .components()
      .flags(GENERATE_PLATE, GENERATE_ROD, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_BOLT_SCREW, GENERATE_SMALL_GEAR, GENERATE_FOIL, GENERATE_DENSE, GENERATE_PLATE_T3, GENERATE_INGOT_T3, GENERATE_PLATE_T4, GENERATE_INGOT_T4, GENERATE_PLATE_T5, GENERATE_INGOT_T5)
